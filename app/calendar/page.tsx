...
import { deriveEvents, EVENT_META, addDays, startOfMonday } from '@/lib/events';
...
export default async function CalendarPage() {
  ...
  const events = deriveEvents(customers, 90);

  const weeks = new Map<string, { weekStart: Date; events: typeof events }>();
  events.forEach((ev) => {
  ...
  return (
    <div className="bg-white">
      ...
      {weekEntries.length === 0 ? (
        <div className="px-8 py-10 text-[13px] text-ink-4">
                  ...
                  <li key={ev.id} className="border-b border-line last:border-b-0">
                    ...
                    >
                      ...
                      <div className="shrink-0 text-right">
                        ...
                        <div className="mt-[2px] text-[10.5px] text-ink-4">
                          {c.health.score} health
                        </div>
                      </div>
                    </Link>
                  </li>
